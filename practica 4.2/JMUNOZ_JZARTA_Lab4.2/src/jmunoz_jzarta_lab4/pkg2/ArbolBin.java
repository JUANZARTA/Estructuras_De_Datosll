...
public class ArbolBin {
    ...
    private Nodo raiz;
    static private int cont_nodos = 0;
    ...
    public void eliminar(int clave, Nodo p, Nodo nodo_anterior, boolean izquierda, boolean derecha) {
        if (p == null) {
            ...
            } else if (this.getRaiz().getDato() == clave) {
                if (p.getDerecha() != null) {
                    Nodo nodo_temp = p.getDerecha();

                    while (nodo_temp.getIzquierda() != null) {
                        nodo_temp = nodo_temp.getIzquierda();
                    }
                    this.eliminar(nodo_temp.getDato(), this.getRaiz().getDerecha(), null, false, false);
    ...
    public int elementos(Nodo r) {
        if (r != null) {
            elementos(r.getIzquierda());
            cont_nodos++;
            elementos(r.getDerecha());
        }
        return cont_nodos;
    }
    ...
    public void mayor(Nodo p) {
        if (p != null) {
            System.out.println("");
            Nodo nodo_temp = this.raiz.getDerecha();
            while (nodo_temp.getDerecha() != null) {
                nodo_temp = nodo_temp.getDerecha();

            }
            if (nodo_temp != null) {
                System.out.println(" el nodo mayor es " + nodo_temp.getDato());
            }
        }else{
    ...
    public void menor(Nodo p) {
         if (p != null) {
        System.out.println("");
        Nodo nodo_temp = this.raiz.getIzquierda();
        if (nodo_temp == null) {
            ...
            if (nodo_temp != null) {
                System.out.println(" el nodo menor es " + nodo_temp.getDato());
            }
        }
         }else{
                        System.out.println(" la raiz no existe ");
